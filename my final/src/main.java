...
//        JButton openFormButton = new JButton("Open Student Form");
//        openFormButton.setFont(new Font("Century Gothic", Font.BOLD, 20));
//        openFormButton.setBackground(new Color(46, 204, 113)); // Green button
//        openFormButton.setForeground(Color.WHITE);
//        openFormButton.setPreferredSize(new Dimension(250, 50));
//        formPanel.add(openFormButton);
//        openFormButton.addActionListener(e -> new StudentForm().createAndShowGUI());
